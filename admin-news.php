...
<html lang="en">
	<head>
		...
		<title>CCAAA | News Management </title>
	...
	<body class="nav-md">
										...
										<div class="row">
											<?php
												...
												<div class="row" style="padding-left: 2%; padding-right: 2%;">
													<a href="#" id="add-news-btn" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
													<hr>
												</div>

												<div class="row add-form" style="display: none;">
													<div class="x_content">
														<form id="add-form" method="post" action="internal/add-news.php" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
															...
															<div class="item form-group">
																<label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">Posted Until <span class="required">*</span>
																</label>
																<div class="col-md-6 col-sm-6 col-xs-12">
																	<input type="date" name="date-until" class="form-control" required="required">
																</div>
															</div>
															<div class="item form-group">
																...
																<div class="col-md-6 col-sm-6 col-xs-12">
																	<input id="file" class="form-control col-md-7 col-xs-12" data-validate-length-range="" data-validate-words="" name="file" placeholder="" required="required" type="file">
																</div>
																<div>
																	<span>*Image must be in gif, jpg or png format only.</span>
																</div>
															</div>
															<div class="form-group">
																<div class="col-md-6 col-md-offset-3">
																	<button type="button" class="btn btn-primary form-cancel">Cancel</button>
																	<button name="add-news-btn" type="submit" class="btn btn-success">Add</button>
																</div>
															</div>
												...
												<div class="row edit-form" style="display: none;">
													<div class="x_content">
														<form id="edit-form" method="post" action="internal/update-news.php" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
															<div class="col-sm-offset-3">
																<h2>Edit News</h2>
															</div>
															<div class="item form-group">
															...
															<div class="item form-group">
																...
																<div class="col-md-6 col-sm-6 col-xs-12">
																	<textarea id="description" required="required" name="description" class="form-control col-md-7 col-xs-12 description"></textarea>
																</div>
															</div>
															<div class="item form-group">
																<label class="control-label col-md-3 col-sm-3 col-xs-12" for="file">File <span class="required">*</span>
															...
															<div class="form-group">
																<div class="col-md-6 col-md-offset-3">
																	<button type="button" class="btn btn-primary form-cancel">Cancel</button>
																	<button name="edit-news-btn" type="submit" class="btn btn-success">Update</button>
																</div>
															</div>
															<div class="ln_solid"></div>
														</form>
											...
											<br />
											<?php include('internal/loadnews.php'); ?>
										</div>
									</div>
								</div>
							</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				loadTable($("#news-handler"), "loaders/loadnews.php");
				...
				$(".edit-news-btn").click(function() {
					...
					$("#edit-form .description").text($(event.target).attr("data-desc"));
				});

				$(".delete-news-btn").click(function() {
					force_url = "internal/delete-news.php";
