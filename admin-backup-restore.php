...
<html lang="en">
	<head>
		...
		<title>CCAAA | Backup & Restore </title>
									...
									<div class="x_content">
										<div class="row">
											...
											<div class="col-md-12" style="padding: 5%;">
												<form name="import" action="internal/backup-restore.php" method="POST" enctype="multipart/form-data">

													<div class="form-group clearfix">
														<button type="submit" name="backup" class="btn btn-primary"><span class="fa fa-download"></span> Backup</button>
													</div>
												</form>

												<form name="export" action="internal/backup-restore.php" method="POST" enctype="multipart/form-data">
													<div class="form-group clearfix">
														<label>File to Restore from: </label>
														<div class="form-group clearfix">
															<input type="file" name="rfile" id="file" title="Please choose an sql file to upload." accept="application/txt" required>
														</div>
														<button type="submit" name="restore" class="btn btn-success"><span class="fa fa-upload"></span> Restore</button>
													</div>
												</form>
											</div>
